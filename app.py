...
restaurantes = [
    {"nome": "CafeTG", "categoria": "Cafeteria", "ativo": False},
    {"nome": "Oh Bruder", "categoria": "Cafeteria", "ativo": True},
    {"nome": "20barra9", "categoria": "Parrilha", "ativo": False},
]
...
def voltar_ao_menu_principal():
    input("\nDigite enter para voltar ao menu princial ")
    main()


# funcao caso o usuario utilize uma tecla invalida
def opcao_invalida():
...
def listar_restaurantes():
    exibir_subtitulo("Todos os restaurantes listados")
